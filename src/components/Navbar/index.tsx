    ...
    <nav className="top-5 sticky w-full z-50 bg-white">
      <div className="flex justify-between items-center max-w-[1240px] mx-auto py-5">
          ...
          {navLinks.map((link) => (
            <li key={link.path}>
              <NavLink
                to={link.path}
                className={({ isActive }) =>
                  `py-[29px] border-b-2 transi hover:text-[#46A358] ${
                    isActive
                      ? "border-[#46A358] text-[#46A358]"
                      : isActive && pathname.includes("/aboutProduct")
                      ? "border-[#46A358] text-[#46A358]"
                      : "border-transparent "
                  }`
                }
        ...
        <div className="flex items-center">
          <button className="cursor-pointer hover:text-[#46A358] transition-all">
            <Search size={24} />
          </button>
          <button
            onClick={() => router("/shop/shopping_cart")}
            className="relative cursor-pointer mx-6 hover:text-[#46A358] transition-all"
          >
          ...
          {isLogged ? (
            <div className="flex items-center gap-3">
              <button
                ...
                className="bg-[#46A358] logo  px-4 py-2 rounded-md text-white flex items-center gap-2 transition-all"
              >
            ...
            <div>
              <button
                type="button"
                onClick={showModal}
                className="bg-[#46A358] font-semibold hover:bg-[#46A358]/70 px-4 py-2 rounded-md text-white flex items-center gap-2 transition-all"
              >
      ...
      >
        <div className="w-full my-4 flex justify-center items-center gap-3 text-xl font-semibold">
          <button
            ...
            className={`${isLoginOpen ? "text-[#46A358]" : ""}`}
          >
            Login
          </button>
